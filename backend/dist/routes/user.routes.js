...
const c = new user_controller_1.UserController();
// Users
/**
 * @openapi
 * /api/user/register:
 ...
 */
r.post('/user/verify-otp', user_middleware_1.checkToken, c.verifyOtp.bind(c));
/**
 * @openapi
 * /api/user/login:
 *   post:
 ...
 */
r.post("/user", user_middleware_1.checkToken, c.getAll.bind(c));
/**
 * @openapi
 * /api/user/id:
 *   get:
 ...
 */
r.get("/user/id", user_middleware_1.checkToken, c.getById.bind(c));
/**
 * @openapi
 * /api/user/edit:
 *   post:
 ...
 */
r.post("/user/edit", user_middleware_1.checkToken, c.edit.bind(c));
/**
 * @openapi
 ...
 *         description: OK
 */
r.patch("/user/reset-password", user_middleware_1.checkToken, c.updatePassword.bind(c));
 ...
 *               phone: { type: string }
 */
r.post("/user/phone", user_middleware_1.checkToken, c.findByPhone.bind(c));
/**
 * @openapi
 * /api/user/nickname:
 *   post:
 ...
 *               nickname: { type: string }
 */
r.post("/user/nickname", user_middleware_1.checkToken, c.findByNickname.bind(c));
/**
 * @openapi
